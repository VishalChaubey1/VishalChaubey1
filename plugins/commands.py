...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('ᴍᴏᴠɪᴇs | ᴜᴘᴅᴀᴛᴇs', url=f"https://t.me/HDFlims4U"),
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('ᴍᴏᴠɪᴇs | ᴄʟɪᴍᴀx', url='https://t.me/+_AdiRR91FiJlMjA1')],[InlineKeyboardButton('ɪᴍᴅʙ | ᴘʀᴇᴍɪᴜᴍ', url='https://t.me/IMDB_PREMIUM')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
